...
bevformer_results = mmcv.load('test/bevformer_tiny/Tue_Apr_23_17_24_52_2024/pts_bbox/results_nusc.json')
sample_token_list = list(bevformer_results['results'].keys())
for id in range(0, 10):
    render_sample_data(sample_token_list[id], pred_data=bevformer_results, out_path=os.path.join('result', sample_token_list[id]))
