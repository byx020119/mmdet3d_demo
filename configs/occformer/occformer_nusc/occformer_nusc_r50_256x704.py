...
sync_bn = True
plugin = True
plugin_dir = "mmdet3d_plugin/occformer/"
...
data_root = 'data/occformer/nuscenes'
nusc_class_metas = 'configs/occformer/_base_/nuscenes.yaml'
...
test_config=dict(
    type=dataset_type,
    data_root=data_root,
    ann_file='data/occformer/nuscenes/nuscenes_infos_temporal_val.pkl',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='data/occformer/nuscenes/nuscenes_infos_temporal_train.pkl',
